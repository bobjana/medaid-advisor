...
open class RagService(
    ...
    private val tableAwareChunker: TableAwareChunker,
    ...
    private fun extractPlanName(normalizedName: String): String =
        when {
            normalizedName.contains("comprehensive", ignoreCase = true) -> {
                "Comprehensive"
            }

            normalizedName.contains("core", ignoreCase = true) -> {
                "Core"
            }

            normalizedName.contains("saver", ignoreCase = true) -> {
                "Saver"
            }

            normalizedName.contains("keycare", ignoreCase = true) -> {
                "KeyCare"
            }

            normalizedName.contains("priority", ignoreCase = true) -> {
                "Priority"
            }

            normalizedName.contains("smart saver", ignoreCase = true) -> {
                "Smart Saver"
            }

            normalizedName.contains("smart", ignoreCase = true) -> {
                "Smart"
            }

            normalizedName.contains("executive", ignoreCase = true) -> {
                "Executive"
            }

            normalizedName.contains("bonclassic", ignoreCase = true) -> {
                "BonClassic"
            }

            normalizedName.contains("boncomprehensive", ignoreCase = true) -> {
                "BonComprehensive"
            }

            normalizedName.contains("boncomplete", ignoreCase = true) -> {
                "BonComplete"
            }

            normalizedName.contains("boncore", ignoreCase = true) -> {
                "BonCore"
            }

            normalizedName.contains("bonessential", ignoreCase = true) -> {
                "BonEssential"
            }

            normalizedName.contains("bonprime", ignoreCase = true) -> {
                "BonPrime"
            }

            normalizedName.contains("bonfit", ignoreCase = true) -> {
                "BonFit"
            }

            normalizedName.contains("bonsave", ignoreCase = true) -> {
                "BonSave"
            }

            normalizedName.contains("bonstart plus", ignoreCase = true) -> {
                "BonStart Plus"
            }

            normalizedName.contains("bonstart", ignoreCase = true) -> {
                "BonStart"
            }

            normalizedName.contains("boncap", ignoreCase = true) -> {
                "BonCap"
            }

            normalizedName.contains("hospital standard", ignoreCase = true) -> {
                "Hospital Standard"
            }

            normalizedName.contains("hospital", ignoreCase = true) -> {
                "Hospital"
            }

            normalizedName.contains("primary", ignoreCase = true) -> {
                "Primary"
            }

            normalizedName.contains("standard select", ignoreCase = true) -> {
                "Standard Select"
            }

            normalizedName.contains("standard", ignoreCase = true) -> {
                "Standard"
            }

            normalizedName.contains("beat 1", ignoreCase = true) -> {
                "Beat 1"
            }

            normalizedName.contains("beat 2", ignoreCase = true) -> {
                "Beat 2"
            }

            normalizedName.contains("beat 3 plus", ignoreCase = true) -> {
                "Beat 3 Plus"
            }

            normalizedName.contains("beat 3", ignoreCase = true) -> {
                "Beat 3"
            }

            normalizedName.contains("beat 4", ignoreCase = true) -> {
                "Beat 4"
            }

            normalizedName.contains("pace 1", ignoreCase = true) -> {
                "Pace 1"
            }

            normalizedName.contains("pace 2", ignoreCase = true) -> {
                "Pace 2"
            }

            normalizedName.contains("pace 3", ignoreCase = true) -> {
                "Pace 3"
            }

            normalizedName.contains("pace 4", ignoreCase = true) -> {
                "Pace 4"
            }

            normalizedName.contains("rhythm 1", ignoreCase = true) -> {
                "Rhythm 1"
            }

            normalizedName.contains("rhythm 2", ignoreCase = true) -> {
                "Rhythm 2"
            }
            ...
            normalizedName.contains("summit", ignoreCase = true) -> {
                "Summit"
            }
            ...
            normalizedName.contains("guide", ignoreCase = true) -> {
                ...
                normalizedName.substringBefore(" ").trim()
            }
        }
    ...
    private fun ingestDocument(
        ...
        clearDocumentChunks(filename)

        val allChunks = tableAwareChunker.chunk(filePath, metadata, chunkSize, chunkOverlap)
    ...
    private fun clearDocumentChunks(filename: String) {
        try {
            jdbcTemplate.update("DELETE FROM vector_store WHERE metadata->>'filename' = ?", filename)
        } catch (e: Exception) {
            log.warn("Could not clear existing chunks for $filename: ${e.message}")
        }
    }
